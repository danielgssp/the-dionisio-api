package com.thedionisio.services.mercado.ctrl;
...
public class MercadoPagoCtrl {
    ...
    /**
     * Instantiate MercadoPagoCtrl with credentials
     */
    public MercadoPagoCtrl(final String client_id, final String client_secret) {
        this.client_id = client_id;
        this.client_secret = client_secret;
    }

    /**
     * Instantiate MercadoPagoCtrl with Long Live Access Token
     */
    public MercadoPagoCtrl(final String ll_access_token) {
    ...
    private static class RestClient {
        ...
        private static Builder buildRequest (String resourceUrl, String contentType) {
            ...
            req.header("User-Agent", "MercadoPago Java SDK v"+ MercadoPagoCtrl.version);
            return req;
        }
    }
}
